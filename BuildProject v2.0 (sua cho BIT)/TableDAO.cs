...
namespace BuildProject {
	...
	public class TableDAO 
	{
		...
		public static ArrayList GetTableIdentityColumn(string connStr, string tableName, TypeOfDatabase typeOfDb) 
		{
            ...
            // edit 2016/08/26 TruyBN
            dt = DataProvider.FillDataSet(connStr, "select c.name Column_Name from sys.objects o inner join sys.columns c on o.object_id = c.object_id where o.name ='" + tableName + "' and c.is_identity = 1").Tables[0];
