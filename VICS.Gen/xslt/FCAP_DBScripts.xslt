...
-- Revise History:	
-- =============================================
CREATE PROCEDURE <xsl:value-of select="entity/@tableName"/>Update<xsl:apply-templates select="entity/columns" mode="Update"/>
AS
BEGIN
	SET NOCOUNT ON;
...
-- Revise History:	
-- =============================================
CREATE PROCEDURE <xsl:value-of select="entity/@tableName"/>Delete<xsl:apply-templates select="entity/columns" mode="Delete"/>
AS
BEGIN
	SET NOCOUNT ON;
...
-- Revise History:	
-- =============================================
CREATE PROCEDURE <xsl:value-of select="entity/@tableName"/>Insert<xsl:apply-templates select="entity/columns" mode="Insert"/>
AS
BEGIN
	SET NOCOUNT ON;
...
-- Revise History:	
-- =============================================
CREATE PROCEDURE <xsl:value-of select="entity/@tableName"/>SelectItem<xsl:apply-templates select="entity/columns" mode="Delete"/>
AS
BEGIN
	SET NOCOUNT ON;
...
-- Revise History:	
-- =============================================
CREATE PROCEDURE <xsl:value-of select="entity/@tableName"/>SelectList
AS
BEGIN
	SET NOCOUNT ON;
...
-- Revise History:	
-- =============================================
CREATE PROCEDURE <xsl:value-of select="entity/@tableName"/>Search<xsl:apply-templates select="entity/columns" mode="Insert"/>
AS
BEGIN
	SET NOCOUNT ON;
