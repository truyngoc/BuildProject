...
Public Class <xsl:value-of select="entity/@tableName"/>_BO	
    ...
    Private Sub KiemTraDieuKienThemMoi(ByVal objData As <xsl:value-of select="entity/@tableName"/>_Info)

    End Sub
    
	Public Sub InsertItem(ByVal objData As <xsl:value-of select="entity/@tableName"/>_Info)
		KiemTraDieuKienThemMoi(objData)
	...
	Public Sub DeleteItem(<xsl:apply-templates select="entity/columns" mode="DeleteParams"/>)
		KiemTraDieuKienHuy(<xsl:apply-templates select="entity/columns" mode="CallDeleteParams"/>)
		Dim bibi As New <xsl:value-of select="entity/@tableName"/>_DAO
	...
	Public Function SelectItem(<xsl:apply-templates select="entity/columns" mode="DeleteParams"/>) as <xsl:value-of select="entity/@tableName"/>_Info
		...
		Dim retVal As New <xsl:value-of select="entity/@tableName"/>_Info
