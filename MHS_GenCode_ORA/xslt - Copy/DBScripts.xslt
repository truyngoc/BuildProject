...
FUNCTION fn_get (<xsl:apply-templates select="entity/columns" mode="Delete"><xsl:with-param name="tableName"><xsl:value-of select="entity/@tableName"/></xsl:with-param></xsl:apply-templates>) RETURN ref_cursor;
